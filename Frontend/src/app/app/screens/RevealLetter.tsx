...
export function RevealLetter({
      ...
      <Frame>
        <div className="flex min-h-[calc(100vh-8vw)] flex-col items-center justify-center text-center">
          ...
          <h1 className="mb-3 font-serif text-[clamp(26px,3.4vw,44px)] font-medium">
            {senderName} left you <span className="font-square-peg">a letter.</span>
          </h1>
  ...
  const { nodes, gallery } = renderLetterBody(body, attachments);
    ...
    <Frame>
      <div className="mx-auto max-w-[760px] animate-[sdRise_0.9s_both]">
        ...
        <div className="rounded-[10px] border border-app-border bg-app-surface p-[clamp(20px,3vw,40px)] shadow-[0_24px_60px_rgba(43,38,33,0.1)] backdrop-blur-xl">
          ...
          {writtenAt && <div className="mb-5 font-square-peg text-[18px] text-app-text">written {fmt(writtenAt)}</div>}
          {hasAnything ? (
          ...
          <div className="mt-8 border-t border-app-border pt-5 font-square-peg text-[20px] text-app-text">— {senderName}</div>
        </div>
    ...
    <Frame>
      <div className="flex min-h-[calc(100vh-8vw)] flex-col items-center justify-center text-center">
        ...
        <h1 className="mb-3 font-serif text-[clamp(20px,2.4vw,30px)] font-medium leading-[1.05]">
          This letter isn&rsquo;t <span className="font-square-peg">ready yet.</span>
        </h1>
